...
use super::result::{Error, ParseConfigurationError};
...
impl TryFrom<[u8; 6]> for ParameterSettings {
    type Error = ParseConfigurationError;

    fn try_from(value: [u8; 6]) -> Result<Self, ParseConfigurationError> {
        let save = match value[0] {
            0xC0 => true,
            0xC2 => false,
            _ => return Err(ParseConfigurationError::InvalidHead(value[0])),
        };
...
impl TryFrom<u8> for Sped {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
...
impl TryFrom<u8> for UartParity {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            0b10 => Ok(Self::E8_1),
            0b11 => Ok(Self::_N8_1),
            _ => Err(ParseConfigurationError::InvalidUartParity(value)),
        }
    }
}
...
impl TryFrom<u8> for UartBaudRate {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            _ => Err(ParseConfigurationError::InvalidUartBaudRate(value)),
        }
    }
}
...
impl TryFrom<u8> for AirDataRate {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            _ => Err(ParseConfigurationError::InvalidAirDataRate(value)),
        }
    }
}
...
impl TryFrom<u8> for Transmission {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            0b1 => Ok(Self::Fixed),
            _ => Err(ParseConfigurationError::InvalidTransmission(value)),
        }
    }
}
...
impl TryFrom<u8> for IoDriveMode {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            0b1 => Ok(Self::PullUp),
            _ => Err(ParseConfigurationError::InvalidIoDriveMode(value)),
        }
    }
}
...
impl TryFrom<u8> for WirelessWakeUpTime {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            _ => Err(ParseConfigurationError::InvalidWirelessWakeUpTime(value)),
        }
    }
}
...
impl TryFrom<u8> for TransmissionPower {
    ...
    fn try_from(value: u8) -> Result<Self, ParseConfigurationError> {
        match value {
            ...
            0b10 => Ok(Self::Dbm24),
            0b11 => Ok(Self::Dbm21),
            _ => Err(ParseConfigurationError::InvalidTxPower(value)),
        }
    }
}
